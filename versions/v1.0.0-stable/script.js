// ============================================================================
// CONFIGURATIE VOOR HÉLÈNE KIOSK
...
function log(msg) {
  ...
  console.log(`[Hélène Kiosk ${timestamp}] ${msg}`);
}
...
function updateEyeState(state) {
  ...
  if (scoutEyesContainer) {
    if (state === "LISTENING") {
      scoutEyesContainer.classList.add("listening");
    } else {
      scoutEyesContainer.classList.remove("listening");
    }
  }
  ...
  eyeWrappers.forEach((eye) => {
    ...
    if (state === "LISTENING") {
      eye.classList.remove("speaking", "blink");
      eye.classList.add("listening");
    } else if (state === "SPEAKING") {
      eye.classList.remove("listening", "blink");
      eye.classList.add("speaking");
    } else {
      eye.classList.remove("listening", "speaking", "blink");
    }
...
// Opstarten van de Kiosk
window.addEventListener("DOMContentLoaded", async () => {
  log("Hélène Kiosk gestart op TV.");
